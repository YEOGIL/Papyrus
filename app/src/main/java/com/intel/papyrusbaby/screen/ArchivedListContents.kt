            ...
            Text(
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        ...
                        navController.navigate(Screen.ImageGeneration.createRoute(encodedLetterText)) {
...
@Composable
fun ArchivedListContentsPreview() {
    val navController = NavController(LocalContext.current)
    val archiveItem = ArchiveItem(
        docId = "testDocId",
        writtenDate = "2023-10-01",
        author = "테스트 작가",
        docType = "일기",
        themeList = listOf("테마1", "테마2"),
        detail = "상세 내용",
        generatedText = "생성된 텍스트"
    )
    ShowArchivedLetterContents(archiveItem, navController)
}
